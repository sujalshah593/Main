  ...
  'sem-1': [
    ...
    },
    {
      ...
      experiments: [
        ...
        { title: 'Visualize AI activation functions.', path: '/activation-functions' },
        { title: 'Represent vectors and matrices.', path: '/vectors-matrices' },
        { title: 'Perform matrix operations and solve linear equations.', path: '/matrix-equations' },
