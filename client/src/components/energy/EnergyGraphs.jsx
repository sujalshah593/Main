...
export default function EnergyGraphs({ history }) {
  ...
  return (
    <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-6 rounded-xl border border-slate-700 h-full flex flex-col">
      ...
      <div className="bg-[#7A1540] dark:bg-slate-900 text-white rounded-lg border border-slate-600 p-2 flex-1 flex items-center justify-center relative">
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2 bg-[#7A1540] dark:bg-slate-900 text-white/80 p-3 rounded-lg border border-slate-700 backdrop-blur-sm">
