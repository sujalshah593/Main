...
export default function EnergyGraphs({ history }) {
  if (history.length < 5) {
    return (
      <div className="bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white p-6 rounded-xl border border-slate-200 dark:border-slate-700 h-full flex flex-col items-center justify-center min-h-[300px]">
        <Activity size={48} className="text-slate-300 dark:text-slate-600 mb-4 animate-pulse" />
        <p className="text-slate-500 dark:text-slate-400 text-center text-sm">Release the ball and observe motion<br/>to generate real-time energy curves.</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white p-6 rounded-xl border border-slate-200 dark:border-slate-700 h-full flex flex-col">
      <h3 className="text-sm font-bold text-slate-500 dark:text-slate-300 mb-4 uppercase tracking-wider flex items-center gap-2">
        <Activity size={16} className="text-emerald-600 dark:text-emerald-400" /> Energy Transformation Graph
      </h3>
      
      <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-600 p-2 flex-1 flex items-center justify-center relative">
        ...
        <div className="absolute top-4 right-4 flex flex-col gap-2 bg-white/80 dark:bg-slate-900 text-slate-900 dark:text-white/80 p-3 rounded-lg border border-slate-200 dark:border-slate-700 backdrop-blur-sm shadow-sm">
