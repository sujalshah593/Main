  ...
  return (
    <div className="glass-panel p-6 rounded-2xl shadow-lg h-full overflow-y-auto custom-scrollbar flex flex-col gap-8">
      ...
      <div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 text-sm text-white mb-4">
...
=======
          <p className="mb-2 text-white">The smallest value that can be measured by the screw gauge.</p>
...
>>>>>>> a52c40dd03a4f368a6dbf5364445cb3430223416
          ...
          <p className='text-white'>For a standard screw gauge: Pitch = 1mm, Total Circular Divisions = 100.<br />
      ...
      <div>
        ...
        <div className="bg-sky-500/10 border border-sky-500/20 rounded-xl p-4 text-sm">
          <p className="text-white mb-3">The final measurement is calculated using:</p>
      ...
      <div className="pb-4">
        ...
        <ol className="list-decimal pl-5 text-sm text-white space-y-2">
