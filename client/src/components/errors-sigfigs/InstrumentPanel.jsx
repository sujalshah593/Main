...
export default function InstrumentPanel({ instrument, measuredValue, trueValue, onJawMove }) {
  ...
  return (
    <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-4 sm:p-6 rounded-xl border border-slate-700 flex flex-col items-center justify-center min-h-[250px] w-full">
      <h3 className="text-lg font-bold text-slate-300 mb-4 capitalize text-center">
        Virtual {instrument.replace('_', ' ')}
      </h3>
      
      <div className="relative w-full h-32 sm:h-40 bg-[#7A1540] dark:bg-slate-900 text-white rounded-lg flex items-center justify-start overflow-hidden border border-slate-600 shadow-inner px-4">
      ...
      <div className="mt-4 flex flex-col items-center">
        <div className="text-2xl sm:text-3xl font-mono font-bold text-sky-400 tracking-wider bg-[#7A1540] dark:bg-slate-900 text-white/50 px-4 py-2 rounded-lg border border-sky-500/20 shadow-[0_0_15px_rgba(14,165,233,0.15)]">
