...
export default function CalculationEngine({ trials, trueValue }) {
  if (trials.length === 0) {
    return (
      <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-6 rounded-xl border border-slate-700 flex items-center justify-center min-h-[300px]">
      ...
      <div className="space-y-6">
        ...
        <div className="mt-6 pt-4 border-t border-slate-700">
          <div className="text-center">
            ...
            <span className="text-2xl font-mono font-bold text-white bg-[#7A1540] dark:bg-slate-900 text-white px-6 py-3 rounded-xl border border-slate-600 inline-block">
