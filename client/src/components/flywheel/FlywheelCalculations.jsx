...
export default function FlywheelCalculations({ trials }) {
  ...
  return (
    <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-6 rounded-xl border border-slate-700 flex flex-col gap-4">
      ...
      <div className="space-y-6 text-sm">
        {/* Step 1 */}
        <div className="p-4 bg-[#7A1540] dark:bg-slate-900 text-white rounded-lg border-l-4 border-emerald-500">
        ...
        {/* Step 2 */}
        <div className="p-4 bg-[#7A1540] dark:bg-slate-900 text-white rounded-lg border-l-4 border-sky-500">
        ...
        {/* Step 3 */}
        <div className="p-4 bg-[#7A1540] dark:bg-slate-900 text-white rounded-lg border-l-4 border-amber-500">
