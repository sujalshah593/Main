...
export default function FlywheelQuiz() {
  ...
  if (isFinished) {
    return (
      <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-8 rounded-xl border border-slate-700 text-center">
    ...
    <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-6 rounded-xl border border-slate-700">
      ...
      <div className="space-y-3">
        {q.options.map((opt, idx) => {
          ...
          if (!showFeedback) {
            styles += "bg-[#7A1540] dark:bg-slate-900 text-white/50 border-slate-700 text-slate-300 hover:border-slate-500 hover:bg-[#7A1540] dark:bg-slate-900 text-white";
          } else {
            ...
            else styles += "bg-[#7A1540] dark:bg-slate-900 text-white/50 border-slate-700 text-slate-500 opacity-50";
          }
