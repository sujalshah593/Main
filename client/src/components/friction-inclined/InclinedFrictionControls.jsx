      ...
      <div className="bg-[#7A1540] dark:bg-slate-800 text-white/50 p-5 rounded-xl border border-slate-700/50">
        ...
        <div className="mt-6 flex gap-2">
           <button 
             ...
             className="flex-1 py-2 bg-[#7A1540] dark:bg-slate-900 text-white border border-slate-700 text-slate-300 rounded-lg text-xs font-bold hover:bg-[#7A1540] dark:bg-slate-800 text-white"
           >
             -0.1°
           </button>
           <button 
