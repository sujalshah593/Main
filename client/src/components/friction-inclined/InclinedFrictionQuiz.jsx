...
const QUESTIONS = [
  {
    ...
    options: [
      "The angle at which the block stops moving",
      "The angle at which the block just begins to slide down the plane",
      "The angle of the plane relative to the vertical",
      "The angle at which the normal reaction is maximum"
    ],
    correct: 1
  },
  {
    question: "If the angle of repose for a surface is 45°, what is the coefficient of friction?",
    options: ["0.5", "0.707", "1.0", "1.414"],
    correct: 2
  },
  {
    question: "As the angle of inclination increases, what happens to the normal reaction (N)?",
    options: ["It increases", "It decreases", "It remains constant", "It first increases then decreases"],
    correct: 1
  },
  {
    question: "Which component of gravity causes the block to slide down the plane?",
    options: ["mg cos θ", "mg tan θ", "mg sin θ", "mg cot θ"],
    correct: 2
  }
];

export default function InclinedFrictionQuiz() {
    ...
    <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-6 rounded-xl border border-slate-700">
      ...
      {showResult ? (
        <div className="text-center py-8">
          ...
          <p className="text-xs text-slate-400 mb-6">You've mastered the concept of Inclined Planes!</p>
          <button 
            onClick={resetQuiz}
                  ...
                  isAnswered
                    ? i === QUESTIONS[currentQuestion].correct
                      ...
                      : i === selectedOption
                        ...
                        : 'bg-[#7A1540] dark:bg-slate-900 text-white border-slate-800 text-slate-500'
                    : 'bg-[#7A1540] dark:bg-slate-900 text-white border-slate-800 text-slate-400 hover:border-slate-600 hover:text-white'
                }`}
              >
