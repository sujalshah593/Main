            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div className="text-[11px] text-slate-300 leading-relaxed">
                  ...
                  <div className="mt-1 p-2 bg-[#7A1540] dark:bg-slate-900 text-white rounded font-mono text-amber-400 text-center">
                    mg sin θ = μ mg cos θ
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-[11px] text-slate-300 leading-relaxed">
                  ...
                  <div className="mt-1 p-2 bg-[#7A1540] dark:bg-slate-900 text-white rounded font-mono text-sky-400 text-center">
                    sin θ / cos θ = μ
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-[11px] text-slate-300 leading-relaxed">
                  ...
                  <div className="mt-1 p-2 bg-[#7A1540] dark:bg-slate-900 text-white rounded font-mono text-emerald-400 text-center">
