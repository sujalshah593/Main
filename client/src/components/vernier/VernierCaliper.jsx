...
export default function VernierCaliper({ jawPosition, setJawPosition, selectedObject, zeroError, showHint }) {
  ...
  return (
    <div className="relative w-full text-white overflow-x-auto pb-10 select-none [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden" ref={constraintsRef}>
      <div className="min-w-[800px] w-[800px] h-[300px] relative mt-10 ml-10 overflow-hidden">
        ...
        <div className="absolute top-[60px] left-0 w-[700px] h-[140px]">
          ...
          {/* Main Beam / Scale */}
          <div className="absolute left-[20px] top-[40px] w-[680px] h-[60px] bg-[#7A1540] dark:bg-slate-800 text-white border-y border-slate-600 shadow-inner flex relative overflow-hidden">
            ...
            {/* Depth Probe Groove */}
            <div className="absolute top-[28px] w-full h-[4px] bg-[#7A1540] dark:bg-slate-900 text-white border-y border-slate-950"></div>
          </div>
        </div>
        ...
        >
          ...
          <div className="absolute top-[35px] left-[20px] w-[100px] h-[70px] bg-gradient-to-b from-slate-600 to-slate-700 border-2 border-slate-500 shadow-xl rounded-sm">
            ...
            <div className="absolute top-[5px] left-[10px] w-[50px] h-[60px] bg-[#7A1540] dark:bg-slate-800 text-white/80 shadow-[inset_0_4px_8px_rgba(0,0,0,0.6)] border border-slate-900 relative">
