...
export default function MotionGraphs({ dataPoints, theoreticalU, theoreticalA }) {
  if (dataPoints.length < 2) {
    return (
      <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-6 rounded-xl border border-slate-700 h-full flex flex-col items-center justify-center min-h-[400px]">
  ...
  return (
    <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-4 rounded-xl border border-slate-700 flex flex-col gap-4 h-full">
      ...
      <div className="flex flex-col sm:flex-row gap-4 h-full">
        ...
        <div className="flex-1 min-w-0 flex flex-col">
          ...
          <div className="bg-[#7A1540] dark:bg-slate-900 text-white rounded-lg border border-slate-600 p-2 flex-1 flex items-center justify-center relative min-h-[150px]">
