...
export default function MotionControls({ 
  ...
  return (
    <div className="bg-[#7A1540] dark:bg-slate-800 text-white p-4 rounded-xl border border-slate-700 flex flex-col gap-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <div className="space-y-3">
            <div className="bg-[#7A1540] dark:bg-slate-900 text-white p-3 rounded-lg border border-slate-600">
        ...
        <div>
          ...
          <label className={`flex items-start gap-2 p-2 rounded-lg border cursor-pointer transition-colors h-full ${isNoiseEnabled ? 'bg-amber-500/5 border-amber-500/20' : 'bg-[#7A1540] dark:bg-slate-900 text-white border-slate-700 hover:border-slate-500'}`}>
