  ...
  return (
    <section className="flex flex-col min-h-[calc(100vh-6rem)] relative z-10 w-full overflow-hidden p-4 lg:p-6">
      ...
      <div className="flex flex-col gap-4 flex-1 overflow-y-auto custom-scrollbar pb-6">
        ...
        {/* Upper Half: Simulation and Graphs */}
          ...
          <div className="lg:col-span-7 flex flex-col gap-4">
            ...
            <div className="flex flex-wrap sm:flex-nowrap gap-3">
              <button 
                ...
                disabled={isPlaying}
                className="flex-1 py-3 bg-sky-600 hover:bg-sky-500 disabled:bg-slate-700 disabled:text-slate-500 text-white rounded-lg font-bold transition-all shadow-lg flex items-center justify-center gap-2 text-sm"
              >
                <Play size={18} fill="currentColor" /> Start Motion
              </button>
              <button 
                onClick={() => setIsPlaying(false)}
                disabled={!isPlaying}
                className="flex-1 py-3 bg-slate-600 hover:bg-slate-500 disabled:bg-slate-700 disabled:text-slate-500 text-white rounded-lg font-bold transition-all flex items-center justify-center gap-2 text-sm"
              >
                <Square size={18} fill="currentColor" /> Pause/Stop
              </button>
            </div>
        ...
        {/* Lower Half: Table and Calculations */}
