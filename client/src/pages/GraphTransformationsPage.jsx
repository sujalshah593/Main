...
import { ArrowLeft, Spline, HelpCircle, Activity, BookOpen } from 'lucide-react';

import LearningPanel from '../components/graph-transformations/LearningPanel.jsx';
...
export default function GraphTransformationsPage() {
  ...
  const resetSimulator = () => {
    setParams({ a: 1, h: 0, k: 0, reflectY: false });
    if (mode === 'practice') {
